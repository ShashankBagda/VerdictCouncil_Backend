...
- For integration work, do not treat the current frontend as the contract. Derive the contract from `docs/architecture/01-user-stories.md` and `/Users/douglasswm/Project/AAS/VER/AGENT_ARCHITECTURE.md`, then align both backend and frontend to that source of truth.
