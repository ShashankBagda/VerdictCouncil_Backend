...
async def _get_redis_client() -> redis.Redis:
    ...
    A single client is reused for the lifetime of the process to avoid
    exhausting the Redis connection pool under load. Call
    :func:`close_redis_client` from the FastAPI lifespan handler on
    shutdown.
    """
